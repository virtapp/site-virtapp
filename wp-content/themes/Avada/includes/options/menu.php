...
function avada_options_section_menu( $sections ) {
	...
	$side_header_width = ( 'top' === $settings['header_position'] ) ? 0 : intval( $settings['side_header_width'] );
	/* translators: value. */
					...
					'main_nav_search_layout'             => [
						...
						'partial_refresh' => [
							'main_nav_search_layout_refresh' => [
								'selector'            => '.fusion-main-menu',
								'container_inclusive' => true,
								'render_callback'     => [ 'Avada_Partial_Refresh_Callbacks', 'menu' ],
							],
						],
						'output'          => [
							[
