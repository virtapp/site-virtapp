...
<div class="wrap about-wrap about-cp bend">
  <div class="wrap-container">
    <div class="bend-heading-section cp-about-header">
      <h1><?php _e( CP_PLUS_NAME . " &mdash; Debugging", "smile" ); ?></h1>
...
", "smile" ); ?></h3>
    ...
    <div class="bend-content-wrap smile-settings-wrapper">
      <h2 class="nav-tab-wrapper">
        ...
        <a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>&view=knowledge_base" title="<?php _e( "knowledge Base", "smile"); ?>" rel="noopener"><?php echo __("Knowledge Base", "smile" ); ?></a>

        <?php if( isset( $_GET['author'] ) ){ ?>
        <a class="nav-tab nav-tab-active" href="?page=<?php echo CP_PLUS_SLUG;?>&view=debug&author=true" title="<?php _e( "Debug", "smile" ); ?>" rel="noopener"><?php echo __( "Debug", "smile" ); ?></a>
        <?php } ?>
      </h2>
