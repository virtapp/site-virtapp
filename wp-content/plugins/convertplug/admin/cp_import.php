...
<div class="wrap about-wrap about-cp bend">
	<div class="wrap-container">
		<div class="bend-heading-section cp-about-header">
			<h1><?php _e( CP_PLUS_NAME. " - Import!", "smile"); ?></h1>
		...
		<div class="bend-content-wrap">
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>" title="<?php _e( "About", "smile"); ?>" rel="noopener" ><?php echo __("About", "smile" ); ?></a>

				<a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>&view=modules" title="<?php _e( "Modules", "smile" ); ?>" rel="noopener" ><?php echo __( "Modules", "smile" ); ?></a>

				<a class="nav-tab nav-tab-active" href="?page=<?php echo CP_PLUS_SLUG;?>&view=cp_import" title="<?php _e( "Import", "smile" ); ?>" rel="noopener" ><?php echo __( "Import", "smile" ); ?></a>

				<?php if($reg_menu_hide !== true) : ?>
				<a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>&view=registration" title="<?php _e( "Registration", "smile"); ?>" rel="noopener"><?php echo __("Registration", "smile" ); ?></a>
				<?php endif; ?>

				<?php if( isset( $_GET['author'] ) ){ ?>
				<a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>&view=debug&author=true" title="<?php _e( "Debug", "smile" ); ?>" rel="noopener"><?php echo __( "Debug", "smile" ); ?></a>
				<?php } ?>

			</h2>
			<?php $selected = ( isset( $_GET['module'] ) && $_GET['module'] !== '' ) ? esc_attr( $_GET['module'] ) : ''; ?>
