...
<div class="wrap about-wrap about-cp bend">
  <div class="wrap-container">
    ...
    <h1><?php _e("Welcome to " . CP_PLUS_NAME . "!", "smile"); ?></h1>
    <h3><?php _e("Welcome to " . CP_PLUS_NAME . " - the easiest WordPress plugin to convert website traffic into leads. " . CP_PLUS_NAME . " will help you build email lists, drive traffic, promote videos, offer coupons and much more!", "smile"); ?></h3>
    ...
    <div class="bend-content-wrap">
	    <h2 class="nav-tab-wrapper">
            ...
            <a class="nav-tab nav-tab-active" href="?page=<?php echo CP_PLUS_SLUG;?>&view=modules" title="<?php _e( "Modules", "smile" ); ?>"><?php echo __( "Modules", "smile" ); ?></a>
    ...
    <div id="smile-module-settings">
        ...
        <a class="button button-secondary button-hero advance-cp-setting" href="?page=<?php echo CP_PLUS_SLUG;?>&view=settings" title="<?php _e( "Advanced Settings", "smile" ); ?>"><?php echo __("Advanced Settings", "smile" ); ?></a>
