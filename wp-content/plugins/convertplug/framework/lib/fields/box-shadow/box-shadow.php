...
function enqueue_box_shadow_param_scripts( $hook ){
  ...
  $data  =  get_option( 'convert_plug_debug' );
	...
	if( $cp_page !== false && isset( $_GET['style-view'] ) && ( $_GET['style-view'] == "edit" || $_GET['style-view'] == "variant" ) ) {
		wp_enqueue_script( 'jquery' );
		wp_enqueue_script( 'jquery-ui-core' );
		
		wp_enqueue_style( 'jquery-ui' );
		wp_enqueue_script( 'box_shadow', SMILE_FRAMEWORK_URI . '/lib/fields/box-shadow/js/boxShadow.js', array('jquery') );
		if( isset( $data['cp-dev-mode'] ) && $data['cp-dev-mode'] == '1' ) {
			wp_enqueue_style( 'box_shadow-layout', SMILE_FRAMEWORK_URI . '/lib/fields/box-shadow/css/layout.css' );
		}
	}
}
