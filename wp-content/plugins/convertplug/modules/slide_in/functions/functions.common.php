...
if( function_exists( "smile_update_settings" ) ){
	...
	$background = array (
		...
		array(
			...
			"dependency" => array('name' => 'slidein_bg_gradient', 'operator' => '==', 'value' => '0'),
			"panel" 	=>  __("Background", "smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),
		array(
			...
			"dependency" => array('name' => 'slidein_bg_gradient', 'operator' => '==', 'value' => true),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),	
...
/*** Array contains animation options ***/
	...
	$affiliate_link = array (
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( 'Did you know that you can earn 30% for each sale you refer to ' . CP_PLUS_NAME . '? Just enter your Envato username and get started!</br></br><a style="text-decoration:none;" href="http://themeforest.net/legal/affiliate" target="_blank">Curious how does it work?</a>', "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" => __("Advance Design Options", "smile" ),
	...
	$behavior = array(
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( "Slide In will trigger after `".$user_inactivity."  ".__("Seconds", "smile" )."` of user inactivity. If you would like, you can change the time <a rel=\"noopener\" target=\"_blank\" href=\"".admin_url('admin.php?page='.CP_PLUS_SLUG.'&view=settings#user_inactivity')."\">here</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> "Smart Launch",
		...
		array(
			...
			"opts"		=> array(
				...
				"on" 		=> __( "YES", "smile" ),
				"off"		=> __( "NO", "smile" ),
				"description"=> __( CP_PLUS_NAME . " can check user history and limit repeat occurrence of Slide In when cookies are enabled. No more annoying Slide Ins!", "smile" ),
			),
	...
	$submission = array(
		...
		array(
			...
			"name" 		=> "inactivity_link",
			"opts"		=> array(
				"link" 		=> __( '"First" is the default and ready to use campaign. If you would like, you can create a new campaign <a href="'.admin_url('admin.php?page=contact-manager&view=new-list&step=1').'" target=\"_blank\" rel=\"noopener\">here</a>.', "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> "Form Setup",
