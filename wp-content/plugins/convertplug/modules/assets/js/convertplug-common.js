    ...
    var ConvertPlus = {
        ...
        _displayPopup: function(md,type,id){
            ...
            if( type == 'modal'){
                ...
                //ConvertPlus._apply_push_page_down(md);
        ...
        _isReferrer: function( referrer, doc_ref, ref_check ){
            var display   = false,
                doc_refs   = ConvertPlus._stripTrailingSlash( doc_ref.replace(/.*?:\/\//g, "") ),
         ...
         * @return Noting
         */
        _apply_push_page_down:function(md){
            setTimeout(function() {
...
jQuery(document).on("cp_close_info_bar", function( event, info_bar ) {
    ...
    element.removeClass('ib-display');
