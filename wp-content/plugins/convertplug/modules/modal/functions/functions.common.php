...
if( function_exists( "smile_update_settings" ) ){
	...
	$background = array (
		...
		array(
			...
			"dependency" => array('name' => 'module_bg_color_type', 'operator' => '==', 'value' => 'gradient'),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),	
		...
		array(
			...
			"dependency" => array('name' => 'module_bg_color_type', 'operator' => '==', 'value' => 'image'),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),
	...
	$adv_design_options = array (
		...
		array(
			...
			"opts"		=> array(
				"title" 	=> __( "Become a " . CP_PLUS_NAME . " Affiliate", "smile" ),
				"value" 	=> true,
				"on" 		=> __( "Yes", "smile" ),
				"off"		=> __( "No", "smile" ),
			),
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( 'Did you know that you can earn 30% for each sale you refer to ' . CP_PLUS_NAME . '? Just enter your Envato username and get started!</br></br><a style="text-decoration:none;" href="http://themeforest.net/legal/affiliate" target="_blank" rel="noopener">Curious how does it work?</a>', "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" => __( "Advance Design Options", "smile" ),
	...
	$behavior = array(
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( "Modal will trigger after `".$user_inactivity."  ".__("Seconds", "smile" )."` of user inactivity. If you would like, you can change the time <a target=\"_blank\" href=\"".admin_url('admin.php?page='.CP_PLUS_SLUG.'&view=settings#user_inactivity')."\" rel=\"noopener\">here</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> __( "Smart Launch", "smile" ),
		...
		array(
			...
			"opts"		=> array(
				...
				"on" 		=> __( "YES", "smile" ),
				"off"		=> __( "NO", "smile" ),
				"description"=> __( CP_PLUS_NAME . " can check user history and limit repeat occurrence of modal when cookies are enabled. No more annoying modals!", "smile" ),
			),
		...
		array(
			...
			"section" =>  __( "Behavior",  "smile" ),
			"section_icon" => "connects-icon-cog",
			"dependency" => array('name' => 'show_for_logged_in', 'operator' => '==', 'value' => 'true')
		),
		array(
			"type" 		=> "checkbox",
			"class" 	=> "",
			...
			"section" =>  __( "Behavior",  "smile" ),
			"section_icon" => "connects-icon-cog",
			"dependency" => array('name' => 'show_for_logged_in', 'operator' => '==', 'value' => 'false')
		),
		array(
			"type" 		=> "switch",
			"class" 	=> "",
		...
		array(
			...
			"dependency" => array('name' => 'display_on_first_load', 'operator' => '==', 'value' => '0'),
			"panel" 	=> __("Target Visitors",  "smile" ),
			"section" =>  __( "Behavior",  "smile" ),
			"section_icon" => "connects-icon-cog"
		),
	...
	$submission = array(
		...
		array(
			...
			"name" 		=> "inactivity_link",
			"opts"		=> array(
				"link" 		=> __( '"First" is the default and ready to use campaign. If you would like, you can create a new campaign <a href="'.admin_url('admin.php?page=contact-manager&view=new-list&step=1').'" target=\"_blank\">here</a>.', "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> __("Form Setup", "smile" ),
...
$modal_layout = array(
    ...
    $jugaad_background = array(
        ...
        array(
			...
			"dependency" => array('name' => 'module_bg1_color_type', 'operator' => '==', 'value' => 'gradient'),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),			
        ...
        array(
			...
			"dependency" => array('name' => 'module_bg1_color_type', 'operator' => '==', 'value' => 'image'),
			"panel" => "Background",
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),
        ...
        array(
			...
			"dependency" => array('name' => 'module_bg2_color_type', 'operator' => '==', 'value' => 'gradient'),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),			
        ...
        array(
			...
			"dependency" => array('name' => 'module_bg2_color_type', 'operator' => '==', 'value' => 'image'),
            "panel"     => __("Background", "smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),
...
if( function_exists( "smile_update_default" ) ){
	...
	$special_offer_default = array(
		...
		"modal_overlay_bg_color" 	 => "rgba(0, 0, 0, 0.7)",
		"affiliate_title"	 	 => __( "Powered by " . CP_PLUS_NAME . "", "smile" ),
		"cp_modal_width"     	 => "750",
	...
	$direct_download_default = array(
		...
		"modal_title1"  	  		=> __( "How to Convert Traffic into Leads with " . CP_PLUS_NAME, "smile" ),
