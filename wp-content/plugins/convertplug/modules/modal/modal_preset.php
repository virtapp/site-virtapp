		...
		$modal_temp_array = array (
			...
			"how_to_learn" =>
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/every_design/every_design.html', // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/screenshot_how_to_learn.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/every_design/customizer.js', // customizer js for template
					"All,Offers", // categories
					"Shortcode,Canvas,HTML,Custom", // tags
			...
			"sharing_is_awesome_do_it" =>
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/social_media/social_media.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_8cc49.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/social_media/customizer.js', // customizer js for template
			...
			"sharing_rounded_icons" =>
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/first_order_2/first_order_2.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_10442.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/first_order_2/customizer.js', // customizer js for template
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/optin_to_win/optin_to_win.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_9a260.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/optin_to_win/customizer.js', // customizer js for template
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/direct_download/direct_download.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_e7b09.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/direct_download/customizer.js', // customizer js for template
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/webinar/webinar.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_8eba4.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/webinar/customizer.js', // customizer js for template
					"All,modal popup,Optins", // categories
					"Shortcode,Canvas,HTML,Custom", // tags
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/first_order/first_order.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/cp_id_8c9f9.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/first_order/customizer.js', // customizer js for template
				...
				array (
					...
					CP_PLUGIN_URL.'modules/modal/assets/demos/special_offer/special_offer.html',	 // HTML file for template
					"http://downloads.brainstormforce.com/convertplug/presets/screenshot_yellow_food_pet.png", // screen shot url for template
					CP_PLUGIN_URL.'modules/modal/assets/demos/special_offer/customizer.js', // customizer js for template
					"All,modal popup,Updates,Offers", // categories
