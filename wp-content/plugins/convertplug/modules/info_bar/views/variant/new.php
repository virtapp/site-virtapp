<div class="wrap smile-add-style bend">
  <div class="wrap-container">
    <div class="bend-heading-section">
      ...
      <h3><a class="add-new-h2" href="?page=smile-info_bar-designer&style-view=variant&variant-style=<?php echo esc_attr( $_GET['variant-style'] ); ?>&style=<?php echo $_GET['style']; ?>&theme=<?php echo esc_attr( $_GET['theme'] ); ?>" title="<?php _e( "Back to Variant's List", "smile" ); ?>">
