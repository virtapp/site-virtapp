...
if( function_exists( "smile_update_settings" ) ) {
	...
	$background = array (
		...
		array(
			...
			"dependency" => array('name' => 'bg_gradient', 'operator' => '==', 'value' => '0'),
			"panel"        => __("Background", "smile" ),
			"section"      => "Design",
			"section_icon" => "connects-icon-image",
		),
		array(
			...
			"dependency" => array('name' => 'bg_gradient', 'operator' => '==', 'value' => true),
			"panel" 	=> __( "Background","smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image"
		),	
	...
	$advance_options = array (
		...
		array(
			...
			"name" 		=> "position_link",
			"opts"		=> array(
				"link" 		=> __( "If your theme has fixed header feature then there might be chances of Push Page will not work. In that case find ID or class of fixed header div & enter it <a target=\"_blank\" href=\"".admin_url('admin.php?page='.CP_PLUS_SLUG.'&view=debug&author=true')."\">here.</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"section"      => "Design",
	...
	$behavior = array(
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( "Info Bar will trigger after `".$user_inactivity."  ".__("Seconds", "smile" )."` of user inactivity. If you would like, you can change the time <a target=\"_blank\" href=\"".admin_url('admin.php?page='.CP_PLUS_SLUG.'&view=settings#user_inactivity')."\">here</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> __( "Smart Launch", "smile" ),
		...
		array(
			...
			"opts"		=> array(
				...
				"on" 		=> __( "YES", "smile" ),
				"off"		=> __( "NO", "smile" ),
				"description"=> __( CP_PLUS_NAME . " can check user history and limit repeat occurrence of Info Bar when cookies are enabled. No more annoying Info Bars!", "smile" ),
			),
...
$submit_btn = array(
	...
	// Style - free_trial
	smile_update_options( "Smile_Info_Bars", "countdown", array_merge(
			$name,
			$background,
			$cont_down_bg,
			$cp_count_down,			
...
if( function_exists( "smile_update_default" ) ){
	...
	$free_trial_default = array(
		...
		"infobar_description"	 	=> __( CP_PLUS_NAME . " is all-in-one software to generate more leads & drive more sales with onsite targeting. ", "smile" ),
		"bg_color"			     => "#2c8dd7",
		"bg_gradient"			 	=> true,
