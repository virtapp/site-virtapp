	...
	class Fusion_Builder_Front {
		...
		public function create_post() {
			...
			$my_post = [
				...
				'post_type'    => $post_type,
				'meta_input'   => [
					'sbg_selected_sidebar_replacement'   => [ 'default_sidebar' ],
					'sbg_selected_sidebar_2_replacement' => [ 'default_sidebar' ],
					'pyre_sidebar_1'                     => [ 'default_sidebar' ],
					'pyre_sidebar_2'                     => [ 'default_sidebar' ],
				],
			];
...
function fusion_element_front_options_loop( $params ) {
	...
	function fusion_display_option( param ) {
		...
		#>
		<li data-option-id="{{ param.param_name }}" data-option-type="{{ param.type }}" class="fusion-builder-option {{ param.type }}{{ hidden }}{{ childDependency }}{{tabGroup}} {{optionMap}}" data-dynamic="{{ hasDynamic }}" data-dynamic-selection="false">
				...
				<div class="option-details-inner">
					<# if ( 'undefined' !== typeof param.heading ) { #>
						...
						<ul class="fusion-panel-options">
							...
							<# if ( supportsDynamic ) { #>
							<li><a class="option-dynamic-content" href="JavaScript:void(0);" aria-label="<?php esc_attr_e( 'Dynamic Content', 'fusion-builder' ); ?>"><i class="fusiona-dynamic-data"></i></a><span class="fusion-elements-option-tooltip fusion-tooltip-preview"><?php esc_html_e( 'Dynamic Content', 'fusion-builder' ); ?></span></li>
							<# } #>
						</ul>
					<# }; #>
				</div>
