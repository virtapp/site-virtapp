		...
		class FusionSC_Video extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				if ( 'yes' === $defaults['box_shadow'] ) {
					$defaults['box_shadow'] = esc_attr( trim( Fusion_Builder_Element_Helper::get_box_shadow_styles( $defaults ) ) );
				}
			...
			[
				...
				'params'     => [
					...
					[
						...
						'description' => esc_attr__( 'Upload an image to display as a video preview.', 'fusion-builder' ),
