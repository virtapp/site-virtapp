...
if ( fusion_is_element_enabled( 'fusion_audio' ) && ! class_exists( 'FusionSC_Audio' ) ) {
	...
	class FusionSC_Audio extends Fusion_Element {
		...
		public static function get_element_defaults() {
			...
			$border_radius   = Fusion_Builder_Element_Helper::get_border_radius_array_with_fallback_value( $fusion_settings->get( 'audio_border_radius' ) );
		...
		public function render( $args, $content = '' ) {
			...
			if ( $this->args['border_radius'] || $this->args['border_size'] || 'yes' === $this->args['box_shadow'] ) {
				...
				if ( 'yes' === $this->args['box_shadow'] ) {
					$styles .= 'box-shadow:' . Fusion_Builder_Element_Helper::get_box_shadow_styles( $this->args );
				}
				$styles .= '}';
			}
			if ( $this->args['border_size'] ) {
		...
		public function attr() {
			...
			// Box shadow.
			if ( 'yes' === $this->args['box_shadow'] ) {
				$style .= '--fusion-audio-box-shadow:' . Fusion_Builder_Element_Helper::get_box_shadow_styles( $this->args );
			}
