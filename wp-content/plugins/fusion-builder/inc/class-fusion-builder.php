...
class FusionBuilder {
	...
	public function init() {
		...
		add_action( 'wp_loaded', [ $this, 'set_body_classes' ] );
	...
	public function admin_styles() {
		...
		if ( current_user_can( 'switch_themes' ) && ! class_exists( 'Avada' ) ) {
	...
	public function shortcode_styles_dynamic_css( $original_styles ) {
		...
		if ( fusion_library()->get_option( 'use_animate_css' ) || $is_builder ) {
	...
	public function register_scripts() {
		...
		Fusion_Dynamic_JS::localize_script(
			...
			[
				...
				'use_animate_css'            => $fusion_settings->get( 'use_animate_css' ),
			]
		);
		Fusion_Dynamic_JS::register_script(
			'jquery-count-to',
	...
	public static function set_element_description_map() {
		...
		$element_option_map['max_width']['audio_video']              = [
		...
		$element_option_map['background_repeat']['fusion_countdown']     = [ 'theme-option' => 'countdown_background_repeat' ];
		$element_option_map['background_position']['fusion_countdown']   = [ 'theme-option' => 'countdown_background_position' ];
