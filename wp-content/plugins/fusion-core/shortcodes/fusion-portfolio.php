					...
					'portfolio_shortcode_section' => [
						...
						'fields'      => [
							...
							'portfolio_load_more_posts_button_bg_color' => [
								...
								'css_vars'    => [
									[
										'name'     => '--portfolio_load_more_posts_button_bg_color',
										'element'  => '.fusion-portfolio',
										'callback' => [ 'sanitize_color' ],
									],
									[
										'name'     => '--portfolio_load_more_posts_button_bg_color-8a',
										'element'  => '.fusion-portfolio',
										'callback' => [ 'color_alpha_set', '0.8' ],
									],
									[
										'name'     => '--portfolio_load_more_posts_button_bg_color-readable-color',
										'element'  => '.fusion-portfolio',
